...
@section('content')
    <div class="content">
		...
		<div class="card">
			<div class="card-body">
				<form class="form-validate-jquery" action="{{ route('promo.store')}}" method="post" enctype="multipart/form-data">
					@csrf
					<fieldset class="mb-3">
                        ...
                        <div class="form-group row">
							...
							<div class="col-lg-10">
								<input type="text" name="kode_promo" class="form-control border-teal border-1 phone-number" placeholder="Kode Promo" required>
                        ...
                        <div class="form-group row">
							...
							<div class="col-lg-10">
								<input type="text" name="nama_promo" class="form-control border-teal border-1 phone-number" placeholder="Nama Promo" required>
							</div>
						</div>
                        <div class="form-group row">
							<label class="col-form-label col-lg-2">Potongan Harga<span class="text-danger">*</span></label>
							<div class="col-lg-10">
								<input type="text" name="potongan" oninput="ribuan2($(this))" class="form-control border-teal border-1" placeholder="Nominal" required>
							</div>
						</div>
                        <div class="form-group row">
                            <label class="col-form-label col-lg-2">Keterangan</label>
                            <div class="col-lg-10">
                                <textarea name="keterangan" cols="10" rows="5" class="form-control border-teal border-1"></textarea>
                            </div>
                        </div>
					</fieldset>
