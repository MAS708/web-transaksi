...
@section('content')
    <div class="content">
		...
		<div class="card">
			<div class="card-body">
				<form class="form-validate-jquery" action="{{ route('barang.update', $barang->id)}}" method="post" enctype="multipart/form-data">
                    @method('PATCH')
					@csrf
					<fieldset class="mb-3">
                        ...
                        <div class="form-group row">
							...
							<div class="col-lg-10">
								<input type="text" name="kode_barang" class="form-control border-teal border-1 phone-number" placeholder="Kode Barang" value="{{ $barang->kode_barang }}" required>
                        ...
                        <div class="form-group row">
							...
							<div class="col-lg-10">
								<input type="text" name="nama_barang" class="form-control border-teal border-1 phone-number" placeholder="Nama Barang" value="{{ $barang->nama_barang }}" required>
							</div>
						</div>
                        <div class="form-group row">
							<label class="col-form-label col-lg-2">Harga<span class="text-danger">*</span></label>
							<div class="col-lg-10">
								<input type="text" name="harga" oninput="ribuan2($(this))" class="form-control border-teal border-1" placeholder="Nominal" value="{{ $barang->harga }}" required>
							</div>
						</div>
					</fieldset>
